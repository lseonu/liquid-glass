...
Core design philosophy and principles for Santai's Liquid Glass UI.
...
- [Liquid Glass Principles](../principles/liquid-glass.md) — Liquid Glass-specific design principles
- [Tokens](../tokens/) — Design tokens (colors, spacing, typography)
- [Patterns](../patterns/) — Ready-to-use component patterns
